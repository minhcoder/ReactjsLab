...
import {Breadcrumb, BreadcrumbItem, Button, Form, FormGroup, Col, Label, Input, Row, FormFeedback} from 'reactstrap';
...
validate(firstname,lastname,telnum,email){
    ...
    if(this.state.touched.firstname&&firstname.length<3){
        errors.firstname="First Name should be equal >=3 characters";
    ...
    if(this.state.touched.lastname&&lastname.length<3){
        errors.lastname="Last Name should be equal >=3 characters";
    }else if(this.state.touched.lastname&&lastname.length>10){
        errors.lastname="Last Name should less than 10 characters";
    }
    const reg=/^\d+$/;
    ...
    if(this.state.touched.email&&email.split('').filter(x=>x==='@').length !==1){
        errors.email="Email should have contain a @ character"
    }
    return errors;
}
    render(){
                ...
                <div className="col-12 col-md-9">
                    <Form onSubmit={this.handleSubmit}>
                        ...
                        <FormGroup row>
                            ...
                            <Col md={10}>
                                <Input type="tel" id="telnum" name="telnum" placeholder="Phone Number" value={this.state.telnum} valid={errors.telnum==""} invalid={errors.telnum!=""}  onBlur={this.handleBlur('telnum')} onChange={this.handleInputChange}/>
                        ...
                        <FormGroup row>
                            <Label htmlFor="message" md={2}>Your Feadback</Label>
                            <Col md={10}>
