...
import {Breadcrumb, BreadcrumbItem, Button, Form, FormGroup, Col, Label, Input, Row} from 'reactstrap';
                ...
                <div className="col-12 col-md-9">
                    <LocalForm onSubmit={(values)=>this.handleSubmit(values)}>
                        <Row className="form-group">
                            ...
                            <Col md={10}>
                                ...
                                messages={{
                                    ...
                                    maxLength:'Must be equal 15 characters or less',
                                }}/>
                            </Col>
                        </Row>
                        <Row className="form-group">
                        ...
                        <Row className="form-group">
                            ...
                            <Col md={10}>
                                <Control.text model=".telnum" id="telnum" name="telnum" placeholder="Phone Number" className="form-control"
                                validators={{
                                    required, maxLength:maxLength(10), minLength:minLength(8),isNumber
                                }}/>
                                <Errors className="text-danger"
                                model=".telnum"
                                show="touched"
                                messages={{
                                    required:'Required',
                                    minLength:"Must be equal 8 numbers",
                                    maxLength:"Must be equal 10 numbers",
